...
public class EmployeeController {
    ...
    Profile prof;
    @GetMapping
    public ArrayList employees() {//este metodo se accede con localhost:8080/users, y retorna la coleccion
        return employees;
    }
    ...
    public ArrayList savex1(@RequestBody Employee empleado)//guardar> implementacion pasando objeto;se accede localhost:8080/users/guardar y por postman le pasas el json
    {
